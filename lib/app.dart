  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: AppStateReloader(
        // F8.1: cihaz takvimi etkinlikleri. `MaterialApp`'in üstünde durur,
        // böylece Bugün/Takvim sekmeleri ve push edilen Ayarlar sayfası aynı
        // denetleyiciyi görür.
            ...
            builder: (context) => AppLanguageScope(
              ...
              child: BlocBuilder<ReminderCubit, ReminderState>(
                ...
                builder: (context, state) {
                  final language =
                      AppLanguageScope.maybeOf(context)?.language ??
                          AppLanguage.system;
                  return MaterialApp(
